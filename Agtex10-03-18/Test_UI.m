...
% Last Modified by GUIDE v2.5 13-Mar-2016 12:08:11
...
try
    ...
    card_type.card840 =struct('no_row',12,'no_col',70,'des_str1',4,'des_end1',38,'des_str2',43,'des_end2',77,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 11],'l2_col',39,'l2_row',[2 11],'l3_col',42,'l3_row',[2 11],'l4_col',80,'l4_row',[2 11],'peg1',3,'peg2',40,'peg3',78,'emg',1,'alias',['860 Hook 10+(12x35)+(12x35)+10']);
...
%     choosen_index = 1;
%     choosen_color =[1 1 1]; % Replacement Color
%     for i=1:length(idx)
...
try
    ...
    %     cnt=0;
    %     card_db=[];
    %     if isempty(find(strcmp(card_choice,struct_index)))==0 % Card match found
    %         %     cnt=cnt+1;
    %         set(handles.checkbox25,'Value',0);
    %         if strcmp(card_choice,'card240')==1
    %             set(handles.popupmenu18,'Visible','on');% Opens new popup
    %             set(handles.text120,'Visible','on');
    %             pop_disp(1)=strcat('12',{'*'},'20');pop_disp(2)=strcat('8',{'*'},'30');pop_disp(3)=cellstr('30 Type');
    %             set(handles.popupmenu18,'String',pop_disp);
    %             %         card_choice={};
    %             %         set(handles.popupmenu18,'Value',2)
    %             %         card_choice{1}='card240';card_choice{2}='card240s';
    %         elseif strcmp(card_choice,'card120')==1
    %             set(handles.popupmenu18,'Visible','on');% Opens new popup
    %             set(handles.text120,'Visible','on');
    %             pop_disp(1)=strcat('6',{'*'},'20');pop_disp(2)=cellstr('20 Type');
    %             set(handles.popupmenu18,'String',pop_disp);
    %             %         card_choice={};
    %             %         set(handles.popupmenu18,'Value',2)
    %             %         card_choice{1}='card240';card_choice{2}='card240s';
    ...
    %
    %     else % Card match not found and checking for cards with emergency
    ...
    %         end
    %     end
    %     if length(img_temp(1,:))==260
    %         card_choice =cellstr('card240s');
    %     end
    %     axes(handles.axes6);
    %     imshow(img_temp);
    %     set(handles.text115,'String',length(img_temp(:,1)));
...
%     end
    ...
    if card_select.emg==0 && strcmp(popupmenuvalue,'30 Type')==1
        thirtytypeCard(img_temp,col,row,card,card_select,card_save,handles) % For thirty type card
    elseif card_select.emg==0 && strcmp(popupmenuvalue,'30 Type')~=1 && strcmp(popupmenuvalue,'20 Type')~=1
...
for i=1:length(handles.uitable1.Data)
    checkBoxSelected(i)=handles.uitable1.Data(i,2);
end
