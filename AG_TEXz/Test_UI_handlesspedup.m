...
% Last Modified by GUIDE v2.5 16-Jun-2016 10:45:07
...
%         axes(handles.axes3);
        ...
        [x_fil y_fil]=find(card_disp_test1==255);
        [x_spa y_spa]=find(card_disp_test1==1);
        plot(handles.axes3,y_peg,x_peg,'og',...
            'MarkerFaceColor','g',...
            'MarkerSize',13);axis([-1 length(card_disp_test1(1,:))+1 -1 length(card_disp_test1(:,1))+1]);
        hold on;set(gca,'YTick',[],'XTick',[]);
        plot(handles.axes3,y_fil,x_fil,'ob',...
            'MarkerFaceColor','b',...
            'MarkerSize',7);
        plot(handles.axes3,y_l,x_l,'or',...
            'MarkerFaceColor','r',...
            'MarkerSize',7);
        plot(handles.axes3,y_spa,x_spa,'ok',...
            'MarkerFaceColor','none',...
            'MarkerSize',7);
%         drawnow();
        if odd_even==0
...
%             axes(handles.axes4);
            ...
            plot(handles.axes4,y_peg,x_peg,'og',...
                'MarkerFaceColor','g',...
                'MarkerSize',13);axis([-1 length(card_disp_test2(1,:))+1 -1 length(card_disp_test2(:,1))+1]);
            hold on;set(gca,'YTick',[],'XTick',[]);
            plot(handles.axes4,y_fil,x_fil,'ob',...
                'MarkerFaceColor','b',...
                'MarkerSize',7);
            plot(handles.axes4,y_l,x_l,'or',...
                'MarkerFaceColor','r',...
                'MarkerSize',7);
            plot(handles.axes4,y_spa,x_spa,'ok',...
                'MarkerFaceColor','none',...
                'MarkerSize',7);
%                 drawnow() ;
...
%             axes(handles.axes5);
            ...
            plot(handles.axes5,y_peg,x_peg,'og',...
                'MarkerFaceColor','g',...
                'MarkerSize',13);axis([-1 length(card_disp_test3(1,:))+1 -1 length(card_disp_test3(:,1))+1]);
            hold on;set(gca,'YTick',[],'XTick',[]);
            plot(handles.axes5,y_fil,x_fil,'ob',...
                'MarkerFaceColor','b',...
                'MarkerSize',7);
            plot(handles.axes5,y_l,x_l,'or',...
                'MarkerFaceColor','r',...
                'MarkerSize',7);
            plot(handles.axes5,y_spa,x_spa,'ok',...
                'MarkerFaceColor','none',...
                'MarkerSize',7);
%                 drawnow() ;
