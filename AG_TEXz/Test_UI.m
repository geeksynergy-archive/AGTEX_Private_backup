...
%
%      TEST_UI('Property','Valfue',...) creates a new TEST_UI or raises the
...
% Last Modified by GUIDE v2.5 18-Mar-2016 18:56:28
...
try
    ...
    splashLoader = waitbar(0.20, splashLoader);
catch
    setappdata(0,'splashLoader', waitbar(0.20, 'Starting AGTEX'));
end
try
    ...
    card_type.card120 =struct('no_row',6,'no_col',20,'des_str1',4,'des_end1',23,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 5],'l2_col',26,'l2_row',[2 5],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',24,'peg3',0,'emg',0,'alias',['120 Hook (6x20)',' /  128 Hook 4+(6x20)+4']);
    
    card_type.card120t =struct('no_row',6,'no_col',20,'des_str1',4,'des_end1',23,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 5],'l2_col',26,'l2_row',[2 5],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',24,'peg3',0,'emg',0,'alias',['120 Hook 20 Type',' /  120 Hook 20 Type']);
    
    card_type.card156 =struct('no_row',6,'no_col',26,'des_str1',4,'des_end1',29,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 5],'l2_col',32,'l2_row',[2 5],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',30,'peg3',0,'emg',1,'alias',['156 Hook (6x26)',' /  164 Hook 4+(6x26)+4']);
    
    card_type.card160 =struct('no_row',8,'no_col',20,'des_str1',4,'des_end1',23,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 7],'l2_col',26,'l2_row',[2 7],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',24,'peg3',0,'emg',0,'alias',['160 Hook (8x20)',' /  172 Hook 6+(8x20)+6']);
    
    card_type.card161 =struct('no_row',7,'no_col',23,'des_str1',4,'des_end1',26,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 6],'l2_col',29,'l2_row',[2 6],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',27,'peg3',0,'emg',1,'alias',['161 Hook (7x23)',' /  169 Hook 4+(7x23)+4']);
    
    card_type.card162 =struct('no_row',6,'no_col',27,'des_str1',4,'des_end1',30,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 5],'l2_col',33,'l2_row',[2 5],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',31,'peg3',0,'emg',1,'alias',['162 Hook (6x27)',' /  170 Hook 4+(6x27)+4']);
    
    card_type.card200 =struct('no_row',8,'no_col',25,'des_str1',4,'des_end1',28,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 7],'l2_col',31,'l2_row',[2 7],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',29,'peg3',0,'emg',1,'alias',['200 Hook (8x25)',' /  212 Hook 6+(8x25)+6']);
    
    card_type.card204 =struct('no_row',6,'no_col',34,'des_str1',4,'des_end1',37,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 5],'l2_col',40,'l2_row',[2 5],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',38,'peg3',0,'emg',1,'alias',['204 Hook(6x34)',' /  212 Hook 4+(6x34)+4']);
    
    card_type.card208 =struct('no_row',8,'no_col',26,'des_str1',4,'des_end1',29,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 7],'l2_col',32,'l2_row',[2 7],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',30,'peg3',0,'emg',1,'alias',['208 Hook (8x26)',' /  220 Hook 6+(8x26)+6'] );
    
    card_type.card240 =struct('no_row',8,'no_col',30,'des_str1',4,'des_end1',33,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 7],'l2_col',36,'l2_row',[2 7],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',34,'peg3',0,'emg',0,'alias',['240 Hook (8x30)',' /  252 Hook 6+(8x30)+6']);
    
    card_type.card240s =struct('no_row',12,'no_col',20,'des_str1',4,'des_end1',23,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[3 10],'l2_col',26,'l2_row',[3 10],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',24,'peg3',0,'emg',1,'alias',['240 Hook (12x20)',' /  260 Hook 10+(12x20)+10']);
    
    card_type.card240t =struct('no_row',8,'no_col',30,'des_str1',4,'des_end1',33,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 7],'l2_col',36,'l2_row',[2 7],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',34,'peg3',0,'emg',0,'alias',['240 Hook 30 Type']);
    
    card_type.card256 =struct('no_row',8,'no_col',32,'des_str1',4,'des_end1',19,'des_str2',21,'des_end2',36,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 7],'l2_col',20,'l2_row',[2 7],'l3_col',39,'l3_row',[2 7],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',37,'peg3',0,'emg',1,'alias',['256 Hook 6+(8x16)+(8x16)+6']);
    
    card_type.card320 =struct('no_row',8,'no_col',40,'des_str1',4,'des_end1',23,'des_str2',25,'des_end2',44,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 7],'l2_col',24,'l2_row',[2 7],'l3_col',47,'l3_row',[2 7],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',45,'peg3',0,'emg',1,'alias',['332 Hook 6+(8x20)+(8x20)+6']);
    
    card_type.card408 =struct('no_row',8,'no_col',51,'des_str1',4,'des_end1',29,'des_str2',31,'des_end2',55,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 7],'l2_col',30,'l2_row',[2 7],'l3_col',58,'l3_row',[2 7],'l4_col',0,'l4_row',  [0],'peg1',3,'peg2',56,'peg3',0,'emg',1,'alias',['420 Hook 6+(8x25)+(8x26)+6']);
    
    card_type.card480 =struct('no_row',8,'no_col',60,'des_str1',4,'des_end1',33,'des_str2',35,'des_end2',64,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 7],'l2_col',34,'l2_row',[2 7],'l3_col',67,'l3_row',[2 7],'l4_col',0,'l4_row',  [0],'peg1',3,'peg2',65,'peg3',0,'emg',1,'alias',['492 Hook 6+(8x30)+(8x30)+6']);
    
    card_type.card500 =struct('no_row',10,'no_col',50,'des_str1',4,'des_end1',28,'des_str2',33,'des_end2',57,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 9],'l2_col',29,'l2_row',[2 9],'l3_col',32,'l3_row',[2 9],'l4_col',60,'l4_row',[2 9],'peg1',3,'peg2',30,'peg3',58,'emg',1,'alias',['500 Hook 8+(10x25)+(10x25)+8']);
    
    card_type.card600 =struct('no_row',12,'no_col',50,'des_str1',4,'des_end1',28,'des_str2',33,'des_end2',57,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 11],'l2_col',29,'l2_row',[2 11],'l3_col',32,'l3_row',[2 11],'l4_col',60,'l4_row',[2 11],'peg1',3,'peg2',30,'peg3',58,'emg',1,'alias',['600 Hook 10+(12x25)+(12x25)+10']);
    
    card_type.card600 =struct('no_row',10,'no_col',60,'des_str1',4,'des_end1',33,'des_str2',38,'des_end2',67,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 9],'l2_col',34,'l2_row',[2 9],'l3_col',37,'l3_row',[2 9],'l4_col',70,'l4_row',[2 9],'peg1',3,'peg2',35,'peg3',68,'emg',1,'alias',['600 Hook 10+(12x25)+(12x25)+10']);
    
    card_type.card620 =struct('no_row',12,'no_col',50,'des_str1',4,'des_end1',28,'des_str2',33,'des_end2',57,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[3 10],'l2_col',29,'l2_row',[3 10],'l3_col',32,'l3_row',[3 10],'l4_col',60,'l4_row',[3 10],'peg1',3,'peg2',30,'peg3',58,'emg',1,'alias',['620 Hook 10+(12x25)+(12x25)+10']);
    
    card_type.card612 =struct('no_row',12,'no_col',51,'des_str1',4,'des_end1',29,'des_str2',31,'des_end2',55,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[3 10],'l2_col',30,'l2_row',[3 10],'l3_col',58,'l3_row',[3 10],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',56,'peg3',0,'emg',1,'alias',['632 Hook 10+(12x26)+(12x25)+10']);
    
    card_type.card616 =struct('no_row',8,'no_col',77,'des_str1',4,'des_end1',29,'des_str2',32,'des_end2',57,'des_str3',60,'des_end3',84,'l_spa',1,'l1_col',1,'l1_row',[2 7],'l2_col',31,'l2_row',[2 7],'l3_col',59,'l3_row',[2 7],'l4_col',87,'l4_row',[2 7],'peg1',3,'peg2',85,'peg3',0,'emg',1,'alias',['628 Hook 6+(8x26)+(8x26)+(8x25)+6']);
    
    card_type.card660 =struct('no_row',10,'no_col',66,'des_str1',4,'des_end1',36,'des_str2',41,'des_end2',73,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 9],'l2_col',37,'l2_row',[2 9],'l3_col',40,'l3_row',[2 9],'l4_col',76,'l4_row',[2 9],'peg1',3,'peg2',38,'peg3',74,'emg',1,'alias',['676 Hook 8+(10x33)+(10x30)+8']);
    
    card_type.card668 =struct('no_row',12,'no_col',54,'des_str1',4,'des_end1',30,'des_str2',35,'des_end2',61,'des_str3',0,'des_end3',0,'l_spa',1,'l1_col',1,'l1_row',[2 11],'l2_col',31,'l2_row',[2 11],'l3_col',34,'l3_row',[2 11],'l4_col',64,'l4_row',[2 11],'peg1',3,'peg2',32,'peg3',62,'emg',1,'alias',['668 Hook 10+(12x27)+(12x27)+10']);
    
    card_type.card672 =struct('no_row',12,'no_col',56,'des_str1',4,'des_end1',31,'des_str2',36,'des_end2',63,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 11],'l2_col',32,'l2_row',[2 11],'l3_col',35,'l3_row',[2 11],'l4_col',66,'l4_row',[2 11],'peg1',3,'peg2',33,'peg3',64,'emg',1,'alias',['692 Hook 10+(12x28)+(12x28)+10']);
    
    card_type.card764 =struct('no_row',12,'no_col',62,'des_str1',4,'des_end1',34,'des_str2',39,'des_end2',69,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[3 10],'l2_col',35,'l2_row',[3 10],'l3_col',38,'l3_row',[3 10],'l4_col',72,'l4_row',[3 10],'peg1',3,'peg2',36,'peg3',70,'emg',1,'alias',['764 Hook 10+(12x31)+(12x31)+10']);
    
    card_type.card740 =struct('no_row',12,'no_col',60,'des_str1',4,'des_end1',33,'des_str2',38,'des_end2',67,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[3 10],'l2_col',34,'l2_row',[3 10],'l3_col',37,'l3_row',[3 10],'l4_col',70,'l4_row',[3 10],'peg1',3,'peg2',35,'peg3',68,'emg',1,'alias',['740 Hook 10+(12x30)+(12x30)+10']);
    
    card_type.card828 =struct('no_row',12,'no_col',69,'des_str1',4,'des_end1',24,'des_str2',26,'des_end2',52,'des_str3',54,'des_end3',74,'l_spa',0,'l1_col',1,'l1_row',[3 10],'l2_col',25,'l2_row',[3 10],'l3_col',53,'l3_row',[3 10],'l4_col',77,'l4_row',[3 10],'peg1',3,'peg2',75,'peg3',0,'emg',1,'alias',['848 Hook 10+(12x21)+(12x27)+(12x21)+10']);
    
    card_type.card840 =struct('no_row',12,'no_col',70,'des_str1',4,'des_end1',38,'des_str2',43,'des_end2',77,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[3 10],'l2_col',39,'l2_row',[3 10],'l3_col',42,'l3_row',[3 10],'l4_col',80,'l4_row',[3 10],'peg1',3,'peg2',40,'peg3',78,'emg',1,'alias',['860 Hook 10+(12x35)+(12x35)+10']);
    ...
    if exist(fullfile(pwd, 'card_type.agtex'),'file')~=2
        save('card_type.agtex','card_type');
    else
        load('card_type.agtex', '-mat' , 'card_type');
    end
    handles.card_type=card_type;
    
    splashLoader = getappdata(0,'splashLoader');
    splashLoader = waitbar(0.40, splashLoader);
    ...
    try
        ...
        try
            ...
            [y, z]=dos(doscmd,'-echo');
            if(y~=0)
                errordlg('critical failure','AGTEX')
                exit;
            end
            delete (Local_Directory);
            foundGC_Punch = 1;
        catch
            errordlg('Critical process failed','AGTEX..!');
            exit;
        end
    ...
    if foundGC_Punch == 1
        ...
        if length(Variables) > 0
            try
                ...
                prog_h = waitbar(1,'Ir-Recoverable Error Occured Restart Application');
                pause(2);
                delete(prog_h);
                close all;
                return;
    ...
    splashLoader = getappdata(0,'splashLoader');
    splashLoader = waitbar(0.80, splashLoader);
    pause(0.1);
    splashLoader = waitbar(1, splashLoader);
    pause(0.1);
...
try
    ...
    l4_col=str2num(get(handles.edit39,'String'));
    l4_row=str2num(get(handles.edit40,'String'));
    %     l4_col=0;
    %     l4_row=0;
    ...
    card_disp=zeros(2*no_row,l_end); %% Template for odd number of rows
    even_template=card_disp; %% Template for even number of rows
    ...
    %% In sert PEG and Emergency holes
    if peg3==0 % Number of peg=2
        ...
        if rem(no_row,2)==0 %Peg for cards with even number of rows
            ...
            %% Display card contents. Modified on 6/15/2017
            showDisplay_card=card_disp;
            if l2_col~=0
                showDisplay_card([1:2:end],[des_str1:des_end1])=4;
            end
            if l3_col~=0
                showDisplay_card([1:2:end],[des_str1:des_end1])=4;
                showDisplay_card([1:2:end],[des_str2:des_end2])=4;
            end
            ...
            template=card_disp;
        else %Peg for cards with odd number of rows
            if emg==1 % Emergency enabled
                template(:,peg1)=255;
                template(:,peg2)=255;
            ...
            %% Display card contents. Modified on 6/15/2017
            showDisplay_card=template;
            if l2_col~=0
                showDisplay_card([1:end],[des_str1:des_end1])=4;
            end
            if l3_col~=0
                showDisplay_card([1:end],[des_str1:des_end1])=4;
                showDisplay_card([1:end],[des_str2:des_end2])=4;
            end
            if l4_col~=0
                showDisplay_card([1:end],[des_str1:des_end1])=4;
                showDisplay_card([1:end],[des_str2:des_end2])=4;
        ...
        if rem(no_row,2)==0 %Peg for cards with even number of rows
            if emg==1 % Emergency enabled
                card_disp([1:2:end],peg1)=255;
                card_disp([1:2:end],peg3)=255;
            end
            card_disp(no_row,peg1)=5;
            card_disp([no_row-1 no_row+1],peg1)=0;
            card_disp(no_row,peg2)=5;
            card_disp([no_row-1 no_row+1],peg2)=0;
            card_disp(no_row,peg3)=5;
            card_disp([no_row-1 no_row+1],peg3)=0;
            ...
            if emg==1 % Emergency enabled
                ...
                template(:,peg3)=255;
                template([round(no_row/2) round(no_row/2)+1 round(no_row/2)-1],peg1)=0;
                template([round(no_row/2) round(no_row/2)+1 round(no_row/2)-1],peg3)=0;
            end
            template(round(no_row/2),peg1)=5;
            template(round(no_row/2),peg2)=5;
            template(round(no_row/2),peg3)=5;
    ...
    [showDisplay_x showDisplay_y]=find(showDisplay_card==4);
    plot(y_peg,x_peg,'og',...
        'MarkerFaceColor','g',...
        'MarkerSize',13);axis([-1 length(card_disp_test1(1,:))+1 -1 length(card_disp_test1(:,1))+1]);
    hold on;set(gca,'YTick',[],'XTick',1:2:length(card_disp_test1(1,:)));
    plot(y_fil,x_fil,'ok',...
        'MarkerFaceColor','y',...
        'MarkerSize',8);
    plot(y_l,x_l,'or',...
    ...
    plot(y_spa,x_spa,'ok',...
        ...
        'MarkerSize',8);
    plot(showDisplay_y,showDisplay_x,'ob',... %Used only for display purpose
        'MarkerFaceColor','b',...
        'MarkerSize',8);
...
try
    ...
    newcardName=['card_H',num2str(crdHoles),'_',char(num2str(randi([0,9999])))];
    cardAliasName = inputdlg('Card Name','Save Card', [1,30]);
    crdNm.alias=char(cardAliasName);
    nas = fieldnames(card_type);
    if find(unique(strcmp(newcardName,nas)))==2
        warndlg('Card already present, cannot update','Card error');
    else
        card_type.(newcardName)=crdNm;
        handles.card_type=card_type;
        save('card_type.agtex','card_type');
        guidata(hObject,handles);
        h = msgbox(sprintf('New card design has been saved successfully in the name %s',char(cardAliasName)));
    end
catch
    warndlg('Please finish card design before saving','Card Design Error');
end
...
set(handles.text248,'String',length(card_gen)-text_start);

set(handles.text81,'String',text_start);
...
while(i<end_no&&int==0)
    keepMealive();
    text_start1=str2double(get(handles.edit33,'String'));
    set(handles.text248,'String',length(card_gen)-text_start1);
    ...
    if bbd==1
        set(handles.edit33,'String',x_data(i));
        if i>2
            set(handles.text202,'String',x_data(i-2));
            set(handles.text203,'String',x_data(i-1));
            set(handles.text204,'String',x_data(i));
        elseif i>1
            set(handles.text203,'String',x_data(i-1));
            set(handles.text204,'String',x_data(i));
        elseif i==1
    ...
    if i>2
        ...
        if odd_even==0
            ...
            hold on;set(gca,'YTick',[],'XTick',1:length(card_disp_test2),'XTickLabel',['.';'.';'.';strread(num2str(1:(length(card_disp_test2)-6)),'%s');'.';'.';'.']);
            plot(y_fil,x_fil,'ob',...
                'MarkerFaceColor','b',...
                'MarkerSize',7);
            plot(y_l,x_l,'or',...
    ...
    %%% Start of Code Added 2nd December
    drawnow() ;
    handles = guidata(hObject);
    int = handles.int;
    if int==1
    ...
    %%% End of Code Added 2nd December
...
pop_disp(1)=cellstr('Top-Left');pop_disp(2)=cellstr('Top-Right');pop_disp(3)=cellstr('Bottom-Left');pop_disp(4)=cellstr('Bottom-Right');
...
try
    ...
    if ~isempty(map)
        ...
        img_temp = double(img_temp)/255; %uinit8 to double conversion
    end
    
    j = reshape(img_temp, [], 3);
    [color, k, idx] = unique(reshape(img_temp, [], 3), 'rows');
    % select color now..
    for colorIndex=1:length(color)
        %         colorName{colorIndex}=['Color ',num2str(colorIndex)];
        colorName{colorIndex}=[''];
        checkbox1{colorIndex}=[false];
    end
    
    %     checkbox1={false;false;false};
    data =[colorName' checkbox1'];
    columnname ={'Color','Select'};
    columnformat = {'char','logical'};
    columneditable =[false true];
    
    handles.uitable1.ColumnName=columnname;
    
    %     if max(unique(color))>1 %uinit8 to double
    %         color=double(color)/255;
    %     end
    
    handles.uitable1.BackgroundColor=color;
    handles.uitable1.Data=data;
    handles.uitable1.RowName=[];
    handles.uitable1.ColumnFormat=columnformat;
    handles.uitable1.ColumnEditable=columneditable;
    handles.idx=idx;
    handles.color=color;
    handles.img_temp=img_temp;
    handles.j=j;
    axes(handles.axes6);
    imshow(img_temp);
    guidata(hObject,handles);
...
try
    ...
    %     Design Arbitration starts here
    
    k = fieldnames(card_type);
    matchingcards=0;
    possiblecards={};
    emergency_card_or_not = {};
    for i=1:length(k)
        %     disp(card_type.(char(k(i,1))));
        presentcardtype = card_type.(char(k(i,1)));
        %       img_col == presentcardtype.no_row * presentcardtype.no_col
        %       img_col == presentcardtype.no_row * presentcardtype.no_col + 2*(presentcardtype.no_row - 2)
        if(img_col== presentcardtype.no_row * presentcardtype.no_col)
            matchingcards = matchingcards + 1;
            possiblecards{matchingcards}={char(k(i,1))};
            emergency_card_or_not{matchingcards}=0;
        end
        if (img_col== presentcardtype.no_row * presentcardtype.no_col + 2*(presentcardtype.no_row - 2))
            matchingcards = matchingcards + 1;
            possiblecards{matchingcards}={char(k(i,1))};
            emergency_card_or_not{matchingcards}=1;
        end
        if (img_col== presentcardtype.no_row * presentcardtype.no_col + 2*(presentcardtype.no_row - 3))
            matchingcards = matchingcards + 1;
            possiblecards{matchingcards}={char(k(i,1))};
            emergency_card_or_not{matchingcards}=1;
        end
    ...
    listdlgcards = {};
    for i=1:length(possiblecards)
        listdlgcards{i}= char(possiblecards{i});
    end
    
    for i=1:length(listdlgcards)
        alias_string_index{i} = find(strcmp(listdlgcards{i},k));
        card_name = card_type.(char(k(alias_string_index{i},1)));
        listdlgcards_disp{i} = card_name.alias;
    end
    
    if length(listdlgcards_disp)>1
        [s,v] = listdlg('PromptString','Select Card:','SelectionMode','single','ListSize',[350 300],'ListString',listdlgcards_disp);
        card_choice=listdlgcards(1,s);
        card_name = card_type.(char(k(alias_string_index{s},1)));
        set(handles.hooks_text,'String',listdlgcards_disp(1,s));
        
        
        if emergency_card_or_not{s}==1
            set(handles.checkbox25,'Value',1);
        else
            set(handles.checkbox25,'Value',0);
        end
    else
        card_choice=listdlgcards(1,1);
        set(handles.hooks_text,'String',listdlgcards_disp(1,1));
        
        if emergency_card_or_not{1}==1
            set(handles.checkbox25,'Value',1);
        else
            set(handles.checkbox25,'Value',0);
        end
    ...
    %% Card Layout for Conversion - 14/11/2018
    
    no_col=card_name.no_col;
    no_row=card_name.no_row;
    
    des_str1=card_name.des_str1;
    des_end1=card_name.des_end1;
    
    des_str2=card_name.des_str2;
    des_end2=card_name.des_end2;
    
    des_str3=card_name.des_str3;
    des_end3=card_name.des_end3;
    
    l_spa=card_name.l_spa;
    
    l1_col=card_name.l1_col;
    l1_row=card_name.l1_row;
    
    l2_col=card_name.l2_col;
    l2_row=card_name.l2_row;
    
    l3_col=card_name.l3_col;
    l3_row=card_name.l3_row;
    
    l4_col=card_name.l4_col;
    l4_row=card_name.l4_row;
    ...
    emg=emergency_card_or_not{1};%card_name.emg;
    ...
    if peg3==0 % Number of peg=2
        ...
        if rem(no_row,2)==0 %Peg for cards with even number of rows
            ...
            if l4_col~=0
                showDisplay_card([1:2:end],[des_str1:des_end1])=4;
                showDisplay_card([1:2:end],[des_str2:des_end2])=4;
                showDisplay_card([1:2:end],[des_str3:des_end3])=4;
            end
            template=card_disp;
        else %Peg for cards with odd number of rows
            if emg==1 % Emergency enabled
            ...
            if l4_col~=0
                showDisplay_card([1:end],[des_str1:des_end1])=4;
                showDisplay_card([1:end],[des_str2:des_end2])=4;
                showDisplay_card([1:end],[des_str3:des_end3])=4;
            end
        end
...
try
    ...
    %     if strcmp(get(handles.popupmenu18,'Visible'),'on')=='1'
    %         if get(handles.popupmenu18,'Value')==1
    %             card_choice={'card240s'};
    %         elseif get(handles.popupmenu18,'Value')==2
    %             card_choice={'card240'};
    %         elseif get(handles.popupmenu18,'Value')==3
    %             card_choice={'card240t'};
    %         end
    %     end
    ...
    if strcmp(get(handles.popupmenu18,'Visible'),'on')==1
        ...
        popupmenuvalue = contents{get(handles.popupmenu18,'Value')};
    end
    if card_select.emg==0 && strcmp(card_choice,'card240t')==1
        thirtytypeCard(img_temp,col,row,card,card_select,card_save,handles) % For thirty type card
    elseif card_select.emg==0 && strcmp(card_choice,'card240t')~=1 && strcmp(card_choice,'card120t')~=1
        no_emgCard(img_temp,col,row,card,card_select,card_save,handles);
    elseif card_select.emg==0 && strcmp(card_choice,'card240t')~=1 && strcmp(card_choice,'card120t')==1
        twentytypeCard(img_temp,col,row,card,card_select,card_save,handles);
    ...
    disp (exception.message);  disp(exception.stack(1));
    h=msgbox('Conversion Unsuccessful','Unsuccessful');
    return;
end
%%
...
try
    ...
    elseif handles.noimg==3
        ...
        if ((min(size(im1)==size(im2)))&&(min(size(im2)==size(im3)))&&(min(size(im1)==size(im3))))==1
            ...
            elseif handles.mergelines==2
                if rem(img_size(1),2)==0
                    mergeimg([1:6:end],:)=im1([1:2:end-1],:);
                    mergeimg([2:6:end],:)=im1([2:2:end],:);
                    mergeimg([3:6:end],:)=im2([1:2:end-1],:);
                    mergeimg([4:6:end],:)=im2([2:2:end],:);
                    mergeimg([5:6:end],:)=im3([1:2:end-1],:);
                    mergeimg([6:6:end],:)=im3([2:2:end],:);
                elseif rem(img_size(1),2)==1
                    mergeimg([1:6:end-3],:)=im1([1:2:end-2],:);
                    mergeimg([2:6:end-3],:)=im1([2:2:end-1],:);
                    mergeimg([3:6:end-3],:)=im2([1:2:end-2],:);
                    mergeimg([4:6:end-3],:)=im2([2:2:end-1],:);
                    mergeimg([5:6:end-3],:)=im3([1:2:end-2],:);
                    mergeimg([6:6:end-3],:)=im3([2:2:end-1],:);
                    mergeimg(end-2,:)=im1(end,:);
...
try
    ...
    devString='TES C\n';
    fprintf(s,devString);
    clearbutton(hObject,handles);
    set(handles.pushbutton130,'BackgroundColor','green');
...
try
    ...
    fprintf(s,devString);
    clearbutton(hObject,handles);
    set(handles.pushbutton131,'BackgroundColor','green');
catch
end
...
try
    ...
    fprintf(s,devString);
    clearbutton(hObject,handles);
    set(handles.pushbutton132,'BackgroundColor','green');
catch
end
...
try
    ...
    fprintf(s,devString);
    clearbutton(hObject,handles);
    set(handles.pushbutton133,'BackgroundColor','green');
catch
end
...
try
    ...
    fprintf(s,devString);
    clearbutton(hObject,handles);
    set(handles.pushbutton134,'BackgroundColor','green');
catch
end
...
try
    ...
    fprintf(s,devString);
    clearbutton(hObject,handles);
    set(handles.pushbutton135,'BackgroundColor','green');
catch
end
...
try
    ...
    fprintf(s,devString);
    clearbutton(hObject,handles);
    set(handles.pushbutton136,'BackgroundColor','green');
catch
end
...
try
    ...
    disp (exception.message);  disp(exception.stack(1));
    set(handles.pushbutton137,'BackgroundColor',[0.043 0.518 0.78]);
...
try
    if strcmp(serData(1:19),'HWID:10101001010100')==1
        ...
        set(handles.pushbutton137,'BackgroundColor','green');
        ...
        set(handles.pushbutton137,'BackgroundColor','red');
...
function clearbutton(hObject,handles)
try
    set(handles.pushbutton130,'BackgroundColor',[0.043 0.518 0.78]);
    set(handles.pushbutton131,'BackgroundColor',[0.043 0.518 0.78]);
    set(handles.pushbutton132,'BackgroundColor',[0.043 0.518 0.78]);
    set(handles.pushbutton133,'BackgroundColor',[0.043 0.518 0.78]);
    set(handles.pushbutton134,'BackgroundColor',[0.043 0.518 0.78]);
    set(handles.pushbutton135,'BackgroundColor',[0.043 0.518 0.78]);
    set(handles.pushbutton136,'BackgroundColor',[0.043 0.518 0.78]);
catch
end
...
try
    ...
    i = start_no;
    if isnan(text_start) || isnan(text_end) || (text_end==0) || (text_start==0) || start_no<1 || start_no>length(card_gen) || end_no>length(card_gen)
        start_no=1;
        end_no=length(card_gen);
        i = start_no;
    else
    ...
    if i>2
        ...
        plot(y_peg,x_peg,'og',...
            'MarkerFaceColor','g',...
            'MarkerSize',13);axis([-1 length(card_disp_test1(1,:))+1 -1 length(card_disp_test1(:,1))+1]);
        hold on;set(gca,'YTick',[],'XTick',1:length(card_disp_test1),'XTickLabel',['.';'.';'.';strread(num2str(1:(length(card_disp_test1)-6)),'%s');'.';'.';'.']);
        plot(y_fil,x_fil,'ob',...
            'MarkerFaceColor','b',...
            'MarkerSize',7);
        plot(y_l,x_l,'or',...
    ...
    set(handles.edit33,'String',start_no);
    set(handles.edit34,'String',end_no);
    guidata(hObject,handles);
catch exception
    disp (exception.message);  disp(exception.stack(1));
...
try
    ...
    end_no=text_end;
    i=start_no;
    if isnan(text_start) || isnan(text_end) || (text_end==0) || (text_start==0) ||  end_no>length(card_gen) ||  start_no<1 || text_start>length(card_gen)
        start_no=1;
        end_no=length(card_gen);
        i=start_no;
    else
...
function uipanel96_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to uipanel96_ButtonDownFcn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
try
    switch eventdata.Key
        ...
        case '1'
            PunchSlot(hObject, eventdata, handles);
        case '0'
            unPunchSlot(hObject, eventdata, handles);
...
try
    ...
    try
        set(handles.text257,'String',cus_card_data);
    ...
    MarkerPosition = zeros(1,4);
    MarkerPosition(1) = 1;
    MarkerPosition(2) = 1;
    MarkerPosition(3) = size(cus_card_data.card_gen{1},1);
    MarkerPosition(4) = size(cus_card_data.card_gen{1},2);
    newMarker=false;
    for i=1:MarkerPosition(3)
        for j=1:MarkerPosition(4)
            if(cus_card_data.card_gen{q}(i,j) == 255) || (cus_card_data.card_gen{q}(i,j) == 1)
                if(i*MarkerPosition(4)+j > MarkerPosition(1)*MarkerPosition(4)+MarkerPosition(2))
                    MarkerPosition(1) = i;
                    MarkerPosition(2) = j;
                    disp(MarkerPosition(1)+ '' + MarkerPosition(2))
                    newMarker=true;
                    break;
                end
            end
    ...
    handles.MarkerPosition = MarkerPosition;
...
try
    ...
    MarkerPosition = handles.MarkerPosition;
    MarkerPosition(1) = int16(coordinates (2));
    MarkerPosition(2) = int16(coordinates (1));
    handles.MarkerPosition = MarkerPosition;
    guidata(hObject,handles);
    Update_Image(hObject, handles,cus_card_data)
catch
...
try
    ...
    marker_disp=zeros(size(card_gen{q}));
    MarkerPosition = handles.MarkerPosition;
    marker_disp(MarkerPosition(1),MarkerPosition(2)) = 1;
    [x_mark y_mark]=find(marker_disp==1);
    
    peg_points = plot(y_peg(1:end),x_peg,'og',...
        'MarkerFaceColor','g',...
        'MarkerSize',13);axis([-1 length(card_disp_test1(1,:))+1 -1 length(card_disp_test1(:,1))+1]);
    hold on;set(gca,'YTick',[],'XTick',1:2:length(card_disp_test1(1,:)),'YDir','reverse');
    ...
    marker_points = plot(y_mark,x_mark,'ok',...
        'MarkerFaceColor','none',...
    ...
    disp (exception.message);  disp(exception.stack(1));
    errordlg('Please select a valid custom card / range','Invalid Custom Card');
    return;
end

function PunchSlot(hObject, eventdata, handles)
try
    disp(1)
    newMarker=false;
    q=handles.q;
    ...
    if cus_card_data.card_gen{q}(MarkerPosition(1),MarkerPosition(2)) == 1
        cus_card_data.card_gen{q}(MarkerPosition(1),MarkerPosition(2)) = 255;
    end
...
function unPunchSlot(hObject, eventdata, handles)
try
    disp(0)
    newMarker=false;
    q=handles.q;
    ...
    if cus_card_data.card_gen{q}(MarkerPosition(1),MarkerPosition(2)) == 255
        cus_card_data.card_gen{q}(MarkerPosition(1),MarkerPosition(2)) = 1;
    end
    for i=1:MarkerPosition(3)
        for j=1:MarkerPosition(4)
            if(cus_card_data.card_gen{q}(i,j) == 255) || (cus_card_data.card_gen{q}(i,j) == 1)
...
% --- Executes during object creation, after setting all properties.
function radiobutton125_CreateFcn(hObject, eventdata, handles)
% hObject    handle to radiobutton125 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
% --- Executes when selected object is changed in uipanel96.
% hObject    handle to the selected object in uipanel96
% eventdata  structure with the following fields (see UIBUTTONGROUP)
%	EventName: string 'SelectionChanged' (read only)
%	OldValue: handle of the previously selected object or empty if none was selected
%	NewValue: handle of the currently selected object
...
function radiobutton125_DeleteFcn(hObject, eventdata, handles)
% hObject    handle to radiobutton125 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
% --- Executes when selected object is changed in uipanel96.
...
% --- Executes when selected object is changed in uipanel96.
function uipanel96_SelectionChangeFcn(hObject, eventdata, handles)
% hObject    handle to the selected object in uipanel96
% eventdata  structure with the following fields (see UIBUTTONGROUP)
%	EventName: string 'SelectionChanged' (read only)
%	OldValue: handle of the previously selected object or empty if none was selected
...
try
    try
        if isempty(handles.x_list)
            handles.x_list = [];
        end
        aa=get(handles.radiobutton125,'Value');
        if aa==1
            set(handles.pushbutton164,'Visible','On');
            x_list = inputdlg('Enter missing cards',...
                'Sample', [1 100],handles.x_list);
            handles.x_list = x_list;
        else
            set(handles.pushbutton164,'Visible','Off');
        end
        guidata(hObject,handles);
    catch
        aa=get(handles.radiobutton125,'Value');
        if aa==1
            ...
            x_list = inputdlg('Enter missing cards',...
                'Sample', [1 100]);
            x_data = str2num(x_list{1,:});
            set(handles.edit33,'String',x_data(1));
            handles.x_list = x_list;
...
try
    card_type=handles.card_type;
    delCardno=get(handles.popupmenu23,'Value');
    if delCardno<=24
        uiwait(warndlg('Default card cannot be deleted','Card delete error'));
    else
        %     struct_index=fieldnames(card_type);
        % card_type = rmfield(card_type,card_type.(struct_index{delCardno}));
        mm1=fields(card_type);
        card_type = rmfield(card_type,mm1(delCardno));
        handles.card_type=card_type;
        save('card_type.agtex','card_type');
        pushbutton161_Callback(hObject,eventdata, handles)
        set(handles.popupmenu23,'Value',length(fields(card_type)));
        guidata(hObject,handles);
    end
catch
    uiwait(warndlg('Selected card doesnot exist','Card delete error'));
end
...
try
    card_type=handles.card_type;
    cardList=fieldnames(card_type);
    aliasList=cell(length(cardList),1);
    for i=1:length(cardList)
        aliasList{i} = card_type.(char(cardList(i))).alias;
    end
    set(handles.popupmenu23,'String',aliasList);
    guidata(hObject,handles);
catch
    %    warndlg('Selected card doesnot exist','Card delete error');
end
...
% --- Otherwise, executes on mouse press in 5 pixel border or over popupmenu23.
function popupmenu23_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu23 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
try
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.pushbutton162,'BackgroundColor','green');
status = dos('RUNDLL32.EXE SETUPAPI.DLL,InstallHinfSection DefaultInstall 132 .\drivers\arduino.inf')
status = dos('RUNDLL32.EXE SETUPAPI.DLL,InstallHinfSection DefaultInstall 132 .\drivers\genuino.inf')
status = dos('.\drivers\dpinst-amd64.exe')
status = dos('.\drivers\dpinst-x86.exe')
status = dos('.\drivers\CDM v2.12.06 WHQL Certified\dpinst-amd64.exe')
status = dos('.\drivers\CDM v2.12.06 WHQL Certified\dpinst-x86.exe')
%status = dos('RUNDLL32.EXE SETUPAPI.DLL,InstallHinfSection DefaultInstall 132 .\drivers\CH341SER\CH341SER.inf')
%status = dos('.\drivers\CH341SER\SETUP.exe')
status = dos('RUNDLL32.EXE SETUPAPI.DLL,InstallHinfSection DefaultInstall 132 .\drivers\CP210x_VCP_Windows\slabvcp.inf')
status = dos('.\drivers\CP210x_VCP_Windows\CP210xVCPInstaller_x64.exe')
status = dos('.\drivers\CP210x_VCP_Windows\CP210xVCPInstaller_x86.exe')
h = msgbox('All driver Installation completed, reconnect the device');
set(handles.pushbutton162,'BackgroundColor',[0.043 0.518 0.78]);
...
% --- Executes on selection change in list_color.
function list_color_Callback(hObject, eventdata, handles)
% hObject    handle to list_color (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% Hints: contents = cellstr(get(hObject,'String')) returns list_color contents as cell array
%        contents{get(hObject,'Value')} returns selected item from list_color


% --- Executes during object creation, after setting all properties.
function list_color_CreateFcn(hObject, eventdata, handles)
% hObject    handle to list_color (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in tag_text.
function tag_text_Callback(hObject, eventdata, handles)
% hObject    handle to tag_text (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.tag_text,'String',['Hooks ',num2str(str2num(get(handles.edit18,'String'))*str2num(get(handles.edit19,'String')))]);


% --- Executes on button press in colorSelectButton.
function colorSelectButton_Callback(hObject, eventdata, handles)
% hObject    handle to colorSelectButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
colorCount=1;
colorUnCount=1;
for i=1:length(handles.uitable1.Data)
    if cell2mat(handles.uitable1.Data(i,2))==1
        checkBoxSelected(colorCount)=i;
        colorCount=colorCount+1;
    else
        checkBoxUnselected(colorUnCount)=i;
        colorUnCount=colorUnCount+1;
    end
end
...
if colorCount>=2
    ...
    img_temp=handles.img_temp;
    j=handles.j;
    choosen_index = checkBoxSelected;
    unchoosen_index = checkBoxUnselected;
    choosen_color =[0 0 0]; % Replacement Black Color
    white_color=[1 1 1];
    
    for m=1:length(checkBoxSelected)
        for i=1:length(idx)
            if(idx(i)==choosen_index(m))
                j(i,:)= choosen_color;
                %             else
                %                 j(i,:)= [1 1 1];% White
            end
    ...
    for m=1:length(checkBoxUnselected)
        for i=1:length(idx)
            if(idx(i)==unchoosen_index(m))
                j(i,:)= white_color;
            end
        end
    end
