...
% Last Modified by GUIDE v2.5 11-Feb-2016 22:20:24
...
try
    ...
    card_type.card160 =struct('no_row',8,'no_col',20,'des_str1',4,'des_end1',23,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 7],'l2_col',26,'l2_row',[2 7],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',24,'peg3',0,'emg',0);
    ...
    card_type.card162 =struct('no_row',6,'no_col',27,'des_str1',4,'des_end1',30,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 5],'l2_col',33,'l2_row',[2 5],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',31,'peg3',0,'emg',1);
    ...
    card_type.card240t =struct('no_row',8,'no_col',30,'des_str1',4,'des_end1',33,'des_str2',0,'des_end2',0,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 7],'l2_col',36,'l2_row',[2 7],'l3_col',0,'l3_row',[0],'l4_col',0,'l4_row',[0],'peg1',3,'peg2',34,'peg3',0,'emg',0);
    ...
    card_type.card480 =struct('no_row',8,'no_col',60,'des_str1',4,'des_end1',33,'des_str2',35,'des_end2',64,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 7],'l2_col',34,'l2_row',[2 7],'l3_col',67,'l3_row',[2 7],'l4_col',0,'l4_row',  [0],'peg1',3,'peg2',65,'peg3',0,'emg',1);
    
    card_type.card500 =struct('no_row',10,'no_col',50,'des_str1',4,'des_end1',28,'des_str2',33,'des_end2',57,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 9],'l2_col',29,'l2_row',[2 9],'l3_col',32,'l3_row',[2 9],'l4_col',60,'l4_row',[2 9],'peg1',3,'peg2',30,'peg3',58,'emg',1);
    ...
    card_type.card660 =struct('no_row',10,'no_col',66,'des_str1',4,'des_end1',36,'des_str2',41,'des_end2',73,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 9],'l2_col',37,'l2_row',[2 9],'l3_col',40,'l3_row',[2 9],'l4_col',76,'l4_row',[2 9],'peg1',3,'peg2',38,'peg3',74,'emg',1);
   
    card_type.card672 =struct('no_row',12,'no_col',56,'des_str1',4,'des_end1',31,'des_str2',36,'des_end2',63,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 11],'l2_col',32,'l2_row',[2 11],'l3_col',35,'l3_row',[2 11],'l4_col',66,'l4_row',[2 11],'peg1',3,'peg2',33,'peg3',74,'emg',1);
    
    card_type.card828 =struct('no_row',12,'no_col',69,'des_str1',4,'des_end1',24,'des_str2',26,'des_end2',52,'des_str3',54,'des_end3',74,'l_spa',0,'l1_col',1,'l1_row',[3 10],'l2_col',25,'l2_row',[3 10],'l3_col',53,'l3_row',[3 10],'l4_col',77,'l4_row',[3 10],'peg1',3,'peg2',74,'peg3',0,'emg',1);
    
    card_type.card840 =struct('no_row',12,'no_col',70,'des_str1',4,'des_end1',38,'des_str2',43,'des_end2',77,'des_str3',0,'des_end3',0,'l_spa',0,'l1_col',1,'l1_row',[2 11],'l2_col',39,'l2_row',[2 11],'l3_col',42,'l3_row',[2 11],'l4_col',80,'l4_row',[2 11],'peg1',3,'peg2',40,'peg3',78,'emg',1);
...
try
    ...
    newcardName=['card',num2str(crdHoles)];
    ...
    if find(unique(strcmp(newcardName,nas)))==2
        ...
        save('card_type.agtex','card_type');
        guidata(hObject,handles);
        h = msgbox(sprintf('New card design has been saved successfully in the name %s',newcardName),'Success');
    end
catch
...
try
    ...
    set(handles.popupmenu23,'String',cardList);
    guidata(hObject,handles);
catch
